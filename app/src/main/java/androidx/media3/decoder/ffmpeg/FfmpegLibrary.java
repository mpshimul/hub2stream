      ...
      new LibraryLoader("ffmpegJNI") {
        ...
        protected void loadLibrary(String name) {
          try {
            ...
            Log.d(TAG, "Native library '" + name + "' loaded successfully");
          } catch (UnsatisfiedLinkError e) {
            Log.e(TAG, "Failed to load native library '" + name + "': " + e.getMessage());
            throw e; // Re-throw so LibraryLoader.isAvailable() returns false
          }
        }
      };
